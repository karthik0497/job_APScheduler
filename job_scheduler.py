...
#         # Select all job details from the 'jobs' table
#         cur.execute("""
...
#         for unit, key in time_units.items():
#             if key in schedule:
#                 value = schedule[key]
#                 if unit == 'minute':
#                     total_minutes += value
...
#                 elif unit == 'month':
#                     total_minutes += value * 60 * 24 * 30  # Approximate month as 30 days
#                 elif unit == 'year':
#                     total_minutes += value * 60 * 24 * 365  # Approximate year as 365 days
...
#         # Update the 'last_run' column for the specific job
#         cur.execute("""
#             UPDATE jobs
#             SET last_run = %s
#             WHERE job_id = %s;
...
#     # Update the 'last_run' column in the database
...
#         # Schedule the job with the calculated interval
